...
public class StopWords {
    ...
    public boolean isStopWord(String word) {
        ...
        return hebrewStopSet.contains(word) || englishStopSet.contains(word.toLowerCase()) ;
    }
}
